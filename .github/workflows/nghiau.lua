return {
 CRAFT_EVENT = {"Anti Bee Egg"},
    ...
    BUY_EGGS = { "Safari Egg", "Spooky Eggg", "Jungle Eggg", "Bug Eggg", "Bee Egg", "Paradise Eggg", "Mythical Eggg", "Rare Summer Eggg", "Common Summer Eggg", "Rare Eggg", "Uncommon Eggg"},
    PLANT_EGGS = { "Safari Egg", "Common Summer Eggg", "Spooky Eggg", "Jungle Eggg", },
