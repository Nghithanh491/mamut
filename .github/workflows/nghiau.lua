return {
    ...
    BUY_EGGS = { "Jungle Egg", 
    -- "Bug Eggg", "Bee Eggg", "Paradise Eggg", "Mythical Eggg", "Rare Summer Eggg", "Common Summer Eggg",
        -- "Legendary Egg",
        "Rare Egg", "Uncommon Egg"},
    PLANT_EGGS = { "Jungle Egg", "Anti Bee Egg",
         -- "Rare Egg", "Fall Egg",  "Bug Egg", "Legendary Egg",  "Common Summer Egg",  "Enchanted Egg", "Sprout Egg", "Gourmet Egg", "Corrupted Zen Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Night Egg", "Paradise Egg",
    },
    ...
    KEEP_PETS = { "Tiger", "Chimpanzee", "Silver Dragonfly", "Firefly", "Mizuchi",  "Red Panda", "Barn Owl", "Swan", ["Marmot"] = 5, ["Space Squirrel"] = 5, "Phoenix", "Drake", ["Wisp"] = 5, ["Luminous Sprite"] = 8, ["Shroomie"] = 1, ["Cardinal"] = 1, "Cockatrice", "Gnome", "Griffin", "Apple Gazelle", "Green Bean", "Lemon Lion", "Golden Goose", "Kitsune", "Corrupted Kitsune", "French Fry Ferret", "Lobster Thermidor",
    ...
    EQUIP_PETS = { ["Rooster"] = 4, ["Starfish"] = 2, ["Tarantula Hawk"] = 1, ["Wasp"] = 1, },
    ...
    PET_WEBHOOK_URL = "https://discord.com/api/webhooks/1291060638541545503/2BpkEkpImuJxXrTNUBABZFtzWXM1XhX1zaqDtv3gB-DxjWMUqVL2AqdS6wtiNvfZPdRF",
    SEED_WEBHOOK_URL = "", 
    NOTIFY_PETS = { "Tiger", "French Fry Ferret", "Mochi Mouse", "Corrupted Kitsune", "Raiju", "Mizuchi", "Bald Eagle", "Koi", "Kitsune", "Fennec Fox", "Disco Bee", "Raccoon", "Queen Bee", "Night Owl", "Dragonfly", "Butterfly", "Mimic Octopus", "Red Fox", "Brontosaurus", "T-Rex", "Ankylosaurus", "Spinosaurus" },
